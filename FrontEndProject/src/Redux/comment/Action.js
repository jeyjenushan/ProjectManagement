...
console.log(error);
dispatch({type:CREATE_COMMENT_FAILURE,message:error.message})
    }
...
console.log(error);
dispatch({type:DELETE_COMMENT_FAILURE,chat:error.message})
    }
}
}
...
console.log(error);
dispatch({type:FETCH_COMMENTS_FAILURE,chat:error.message})
    }
